...
int CAPEInfo::GetInfo(APE_DECOMPRESS_FIELDS Field, int nParam1, int nParam2)
{
    ...
    case APE_INFO_WAV_HEADER_DATA:
    {
        ...
        if (m_APEFileInfo.nFormatFlags & MAC_FORMAT_FLAG_CREATE_WAV_HEADER)
        {
            ...
            {
                WAVEFORMATEX wfeFormat; GetInfo(APE_INFO_WAVEFORMATEX, (int) (size_t)&wfeFormat, 0);
    ...
    case APE_INFO_IO_SOURCE:
        nRetVal = (int) (size_t)m_spIO.GetPtr();
        break;
    ...
    case APE_INFO_TAG:
        nRetVal = (int) (size_t)m_spAPETag.GetPtr();
        break;
    case APE_INTERNAL_INFO:
        nRetVal = (int) (size_t)&m_APEFileInfo;
        break;
    default:
	break;
    }
